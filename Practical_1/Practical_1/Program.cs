...
namespace StudentAdmissionManagement
{
    class Student
    {
        ...
        private string course; private double fees;

        public Student()
        {
            studentId = 0; studentName = ""; age = 0;
            course = ""; fees = 0;
        }
        public Student(int id, string name, int age, string course, double fees)
        {
            studentId = id; studentName = name; this.age = age; this.course = course; this.fees = fees;
        }

        public void DisplayStudent()
        {
            Console.WriteLine("\n------ Student Admission Details	");
            Console.WriteLine("Student ID	: " + studentId); Console.WriteLine("Student Name : " + studentName); Console.WriteLine("Age	: " + age); Console.WriteLine("Course	: " + course); Console.WriteLine("Fees	: " + fees);
        }
    }
